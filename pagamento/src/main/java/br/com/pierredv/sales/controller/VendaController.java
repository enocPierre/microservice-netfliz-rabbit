package br.com.pierredv.sales.controller;
...
public class VendaController {
	...
	public VendaController(VendaService produtoService, PagedResourcesAssembler<VendaVO> assembler) {
		super();
		this.vendaService = produtoService;
...
public VendaVO update(@RequestBody VendaVO vendaVO) {
	VendaVO proVo = vendaService.upadte(vendaVO);
